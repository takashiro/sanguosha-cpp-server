...
test: $(KARUTADIR)/$(BINDIR)/sanguosha-unittest
	./$(KARUTADIR)/$(BINDIR)/sanguosha-unittest

$(KARUTADIR)/$(BINDIR)/sanguosha-unittest: $(BINDIR)/unittest
	cp -f $(BINDIR)/unittest $(KARUTADIR)/$(BINDIR)/sanguosha-unittest

$(BINDIR)/unittest: $(TESTOBJECTS) | $(BINDIR)/$(TARGET)
	$(CXX) -o $(BINDIR)/unittest $(TESTOBJECTS) $(LFLAGS) $(EXECFLAGS) -lsanguosha
